...
export default {
  ...
  data () {
    return {
      ...
      // flickity
      flickityImgList: [
        require('@/assets/storyboard-1.png'),
        require('@/assets/storyboard-2.png'),
        require('@/assets/storyboard-3.png'),
        require('@/assets/storyboard-4.png'),
        require('@/assets/storyboard-5.png'),
        require('@/assets/storyboard-6.png'),
        require('@/assets/storyboard-7.png'),
        require('@/assets/storyboard-8.png'),
        require('@/assets/storyboard-9.png'),
        require('@/assets/storyboard-10.png'),
      ],
      flickityOptions: {
        // hash: true,
        lazyLoad: true,
